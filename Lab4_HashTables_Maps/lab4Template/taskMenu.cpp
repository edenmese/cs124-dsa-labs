...
void TaskMenu::editTask() {
    ...
    if (taskPtr != nullptr) {
        ...
        while (!doneEditing) {
            ...
            int choice = editDetails.doMenuIndex();
    ...
    while (command != EXIT) {
        ...
        case DONE:
            ...
            case EXIT:
                ...
                saveToCSV("/Users/edenmese/Desktop/Ohlone/2024/CS-124/Lab4_HashTables_Maps/lab4Template/task_data.csv", *tasksUnorderedMap);
